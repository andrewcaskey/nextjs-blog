...
function Navbar({ topics }) {
  ...
  return (
    <>
      ...
      <header className="fixed w-full border-t-4 bg-white dark:bg-dark border-blue-500 dark:border-blue-900 shadow dark:shadow-2 z-50">
        <div className="container mx-auto px-6 py-5">
          <div className="flex items-center justify-between">
            <div className="flex">
              <Link href="/">
                <a className="flex items-center hover:text-blue-500 text-gray-800 dark:text-gray-50">
              ...
              <div className="dropdown inline-block relative mx-2">
                <a className="flex items-center hover:text-blue-500 text-gray-800 dark:text-gray-50 mx-6 cursor-pointer">
                  <span className="text-xl font-semibold">
            ...
            <div className="flex items-center -mx-3">
              <button
                className="flex items-center mx-2 lg:mx-4 text-base text-gray-800 hover:text-blue-500 dark:text-gray-50"
                onClick={toggleTheme}
              >
              ...
              <Link href="/about">
                <a className="flex items-center mx-2 lg:mx-4 text-base text-gray-800 hover:text-blue-500 dark:text-gray-50">
              ...
              <button className="flex items-center mx-2 lg:mx-4 text-base text-gray-800 hover:text-blue-500 dark:text-gray-50">
                {isLogin ? (
                  <span
